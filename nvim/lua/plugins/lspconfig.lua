...
function M.config()
  ...
  wk.add {
    ...
    { "<leader>lg", "", desc = "g command" },
    { "<leader>lgD", "<cmd>lua vim.lsp.buf.declaration()<CR>", desc = "declaration" },
    { "<leader>lgI", "<cmd>lua vim.lsp.buf.implementation()<CR>", desc = "implementation" },
    { "<leader>lgd", "<cmd>lua vim.lsp.buf.definition()<CR>", desc = "definition" },
    { "<leader>lgl", "<cmd>lua vim.diagnostic.open_float()<CR>", desc = "diagnostic open" },
